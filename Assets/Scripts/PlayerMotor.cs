...
public class PlayerMotor : MonoBehaviour
{
  ...
  private Animator anim;
   ...
   //Custom IsGrounded method
   private bool IsGrounded()
   {
       Ray groundRay = new Ray(new Vector3(controller.bounds.center.x,(controller.bounds.center.y - controller.bounds.extents.y) 
   ...
   //Default CharacterController function
